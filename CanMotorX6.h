...
class CanMotorX6 {
public:
    CanMotorX6(char *canName, std::string canName_temp, std::string bitRate) {
        std::string command3 =
...
//socket 생성
void CanMotorX6::initCanInterface(const char *ifname) {
    //CAN socket 생성
    mCanName = ifname;
...
// Data 보내기
void CanMotorX6::canSend(const u_int8_t *data, int motorID)
{
...
void CanMotorX6::getEncoder(int motorID) {
    /*
...
float CanMotorX6::getMultiturnAngularPosition(int motorID) {
...
void CanMotorX6::turnOffMotor(int motorID) {
...
void CanMotorX6::stopMotor(int motorID) {
...
void CanMotorX6::turnOnMotor(int motorID) {
...
void CanMotorX6::setTorque(int motorID, int torque_int) {
...
void CanMotorX6::setVelocity(int motorID, int velocity) {
    //0.01dps/LSB
...
void CanMotorX6::setPosition1(int motorID, double desiredPosition_rad) {
    //0.01rad/LSB
...
void CanMotorX6::setPosition2(int motorID, double desiredPosition_rad, int maxSpeed_dps) {
    //0.01rad/LSB
    double rad2deg = 180 / 3.141592;
    double position_Deg = desiredPosition_rad * rad2deg * 100 * mGearRatio;
    int position_int = (int) round(position_Deg);
